...
export default function SubCategoryPage() {
  ...
  const sortedProducts = useMemo(() => {
    const productsCopy = [...subcategoryProducts];
    ...
    return productsCopy;
  }, [currentSort, subcategoryProducts]);
    ...
    <>
      ...
      <section className="subcategory-page">
        <div className="container">
          <div className="subcategory-page__wrap">
            <Breadcrumbs
              items={[
                { label: 'Главная', path: '/' },
                {
                ...
                {
                  label: currentSubcategory.title,
                  path: `/category/${currentCategory.id}/subcategory/${currentSubcategory.id}`,
                },
              ]}
            />
            <h1 className="subcategory-page__title">
              {currentSubcategory.title}
            </h1>
            <div className="subcategory-page__products-wrap">
              <div className="subcategory-page__controls">
                <button
                  className="subcategory-page__control"
                  type="button"
                  onClick={() => {
                ...
                >
                  <svg
                    className="subcategory-page__control-icon"
                ...
                <div className="subcategory-page__sort" ref={sortRef}>
                  <button
                    className="subcategory-page__control subcategory-page__sort-btn"
                    type="button"
                  ...
                  {isSortOpen && (
                    <ul className="subcategory-page__sort-list">
                      {sortItems.map((sortItem) => (
                        <li
                          className="subcategory-page__sort-item"
                          key={sortItem.id}
                        >
                          <button
                            className={`subcategory-page__sort-option ${
                              currentSort === sortItem.id
                                ? 'subcategory-page__sort-option--active'
                                : ''
                            }`}
                            type="button"
              ...
              <ul className="subcategory-page__products">
                {sortedProducts.map((product) => (
                  <li key={product.id} className="subcategory-page__product">
